    ...
    <body>
        ...
        <section class="body">
                                            ...
                                            <div class="col-lg-12">
                                                <section class="panel">
                                                    <header class="panel-heading">
                                                        ...
                                                        <h2 class="panel-title">Input Level</h2>
                                                    </header>
            ...
            try {
                ...
                String Data = "select * from kendala where id_kendala=" + id_kendala;
                rs = statement.executeQuery(Data);
                while (rs.next()) {
        %>
                                                        <form action="save_level.jsp" class="form-horizontal form-bordered" method="get">
												...
												<div class="col-md-6">
													...
													<select name="level" class="form-control input-sm mb-md">
