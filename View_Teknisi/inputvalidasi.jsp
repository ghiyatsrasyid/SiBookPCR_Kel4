    ...
    <body>
        ...
        <section class="body">
                                ...
                                <ul class="nav nav-main">
                                    ...
                                    <li class="nav-parent nav-expanded nav-active">
										...
										<ul class="nav nav-children">
												...
												<a href="info_kendala.jsp">
													 Info Kendala
												</a>
											</li>
                                                                                        <li>
												<a href="input_level.jsp">
													 Pemberian Level
												</a>
											</li>
                                                                                    
                                                                                         <li>
												<a href="data_kendala.jsp">
													 Data Kendala
												</a>
											</li>
                                                                                         <li class="nav-active">
												<a href="inputvalidasi.jsp">
													Validasi
												</a>
											</li>
                                                                        <li>
                                            ...
                                            <div class="col-lg-12">
                                                <section class="panel">
                                                    <header class="panel-heading">
                                                        ...
                                                        <h2 class="panel-title">Status Perbaikan</h2>
                                                    </header>
            ...
            try {
                ...
                String Data = "select * from kendala2 where id_kendala=" + id_kendala;
                rs = statement.executeQuery(Data);
                while (rs.next()) {
        %>
                                                        <form action="save_validasi.jsp" class="form-horizontal form-bordered" method="get">
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label" for="inputDefault">Nama Instruktur Lab</label>
                                                                <div class="col-md-6">
                                                                    <input name="id_kendala" value="<%=rs.getString("id_kendala")%>"  type="hidden" class="form-control" id="inputReadOnly" readonly="readonly">
                                                                    <input name="laboran" value="<%=rs.getString("laboran")%>"  type="disable" class="form-control" id="inputReadOnly" readonly="readonly">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input name="date" type="text" id="date" value="<%=rs.getString("date")%>" class="form-control" readonly="readonly" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input name="lab" type="text" class="form-control" id="lab" value="<%=rs.getString("lab")%>"readonly="readonly" >
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input name="pc" class="form-control" value="<%=rs.getString("pc")%>" readonly="readonly">                                                                        
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input name="kendala" type="text" class="form-control" value="<%=rs.getString("kendala")%>" rows="3" id="inputReadOnly" readonly="readonly"></input>
                                                                </div>
                                                            </div>
                                                             
                                                                                          <div class="form-group">
												<label class="col-md-3 control-label" for="inputSuccess">level</label>
												<div class="col-md-6">
													
													<input name="level" type="text" class="form-control" value="<%=rs.getString("level")%>" rows="3" id="inputReadOnly" readonly="readonly"></input>
												</div>
											</div>
                                                                
                                                                                            <div class="form-group">
												<label class="col-md-3 control-label" for="inputSuccess">Status Perbaikan</label>
												<div class="col-md-6">
													
													<select name="validasi" class="form-control input-sm mb-md">
														<option>Selesai</option>
                                                                                                                <option>Tidak Dapat Di Perbaikin</option>
													</select>
												</div>
											</div>
                                                                                            <div class="form-group">
													...
													<div class="col-md-6">
														<div class="input-group">
															...
															<input name="TanggalPenyelesaian" type="date" id="date" placeholder="<%= new java.util.Date()%>" class="form-control"  >
														</div>
													</div>
												</div>
						
                                                                                         <div class="form-group">
												<label class="col-md-3 control-label" for="inputSuccess">Teknisi</label>
												<div class="col-md-6">
													
													<select name="Teknisi" class="form-control input-sm mb-md">
														<option>Muharfan</option>
                                                                                                                <option>Aris Suandi</option>
                                                                                                                <option>Raja Septama </option>
													</select>
												</div>
											</div>
