<%-- 
    Document   : pemberian_level
    Created on : Jan 13, 2022, 7:28:03 PM
    Author     : Lenovo
--%>
	...
	<body>
													 ...
													 History Kendala
                                                                                        ...
                                                                                        <li class="nav-parent nav-expanded nav-active">
                                                                                            ...
                                                                                            <ul class="nav nav-children">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="../../DataLogbookPeminjamanLab/LogbookPeminjamanLab.jsp">
        ...
        <%
            try {
                ...
                String Data = "select * from kendala2";
                rs = statement.executeQuery(Data);
        %>
        <form action="save_level.jsp" method="get">
		...
		<thead>
			...
			<th>Pc</th>
                ...
                <tr>
                    <%while (rs.next()) {%>
                    <input type="hidden" name="id_kendala" value="<%=rs.getString("id_kendala")%>">
                    <td><%=rs.getString("id_kendala")%></td>
                    <input type="hidden" name="laboran" value="<%=rs.getString("laboran")%>">
                    <td><%=rs.getString("laboran")%></td>
                    <input type="hidden" name="date" value="<%=rs.getString("date")%>">
                    <td><%=rs.getString("date")%></td>
                    <input type="hidden" name="lab" value="<%=rs.getString("lab")%>">
                    <td><%=rs.getString("lab")%></td>
                    <input type="hidden" name="pc" value="<%=rs.getString("pc")%>">
                    <td><%=rs.getString("pc")%></td>
                    <input type="hidden" name="kendala" value="<%=rs.getString("kendala")%>">
                    <td><%=rs.getString("kendala")%></td>
                    <input type="hidden" name="level" value="<%=rs.getString("level")%>">
                    <td><%=rs.getString("level")%></td>
                    
                    <td><a href="inputvalidasi.jsp?id_kendala=<%=rs.getString("id_kendala")%>">konfirmasi</a></td>
                </tr>
            <%}%>
                                                                        </tbody>
								</table>
