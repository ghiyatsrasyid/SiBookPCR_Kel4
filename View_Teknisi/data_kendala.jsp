	...
	<body>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Data Kendala Dalam Proses Perbaikan</h2>
							</header>
        ...
        %>
            ...
            <tr>
                ...
                <td><a href="inputvalidasi.jsp?id_kendala=<%=rs.getString("id_kendala")%>
                       "onclick = "return confirm('Apakah Kerusakan Pada Lab Telah Selesai Ditangani?');">Konfirmasi</a></td>
