	...
	<body>
		<section class="body">
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">History Kerusakan Di LAB</h2>
							</header>
            ...
            try {
                ...
                String Data = "select * from history";
        ...
        %>
            ...
            <tr>
                ...
                <td><%=rs.getString("TanggalPenyelesaian")%></td>
                <td><%=rs.getString("Teknisi")%></td>
                <td><%=rs.getString("validasi")%></td>
            </tr>
            <%}%>
                                                                        </tbody>
								</table>
