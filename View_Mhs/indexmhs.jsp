	...
	<div class="row">
		<section class="panel">
			...
			<div class="panel-body">
				<p class="m-none">
				<%
                                List<Membukalogbook> listmb=SimpleDB.getidlabonmembukalogbook();
                                for(Membukalogbook i:listmb){%>
                                    <a href="pc.jsp?idLab=<%= i.getIdLab()%>&jam=<%= i.getJam() %>&tanggal=<%=i.getTanggal() %>" class="mb-xs mt-xs mr-xs btn btn-lg btn-primary "><%= i.getIdLab() %></a>
                                <%
