...
<html class="fixed">
	<head>
		...
		<title>Form Input Logbook| Okler Themes | Porto-Admin</title>
		...
		<section class="body">
			...
			<div class="inner-wrapper">
                ...
                <section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Mengisi Logbook</span></li>
							</ol>
                    ...
                    <div class="row">
						<div class="col-lg-12">
							<form id="form" action="newmhs.jsp" method="get" class="form-vertical">
								<section class="panel">
										...
										<div class="panel-actions">
											...
											<a href="#" class="fa fa-times"></a>
                                                                                        ...
                                                                                        <% 
                                                                                            ...
                                                                                            List<Membukalogbook> listmb = SimpleDB.getdatamembukalogbook(idLab);
                                                                                            for (Membukalogbook e:listmb) {
                                                                                        %>
										</div>
										<h2 class="panel-title">Form Mengisi Logbook</h2>
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-3">
                                                                                            ...
                                                                                            <input type="hidden" name="tanggal" value="<%=e.getTanggal()%>"/>
                                                                                            <input type="hidden" name="jam" value="<%=e.getJam()%>"/>
                                                                                            <input type="hidden" name="sks" value="<%=e.getSks()%>"/>
                                                                                            <input type="hidden" name="namakegiatan" value="<%=e.getNamakegiatan()%>"/>
                                                                                            <input type="hidden" name="idilb" value="<%=e.getilb()%>"/>
											...
											<div class="col-sm-3">												
                                                                                            <input type="text" name="jammhs" class="form-control" value="<%= format3 %>" readonly="readonly"/>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-3">												
											    <input type="text" name="namamhs" class="form-control"/>
                                                                                ...
                                                                                <div class="form-group">
											<label class="col-sm-3 control-label">No PC</label>
											<div class="col-sm-3">												
                                                                                            <input type="text" name="nopc" class="form-control" value="<%= nopc%>" readonly="readonly"/>
											</div>
										</div>
                                                                                <%
                                                                                    }
