...
<html class="fixed">
    <head>
        ...
        <link rel="stylesheet" href="../View/assets/vendor/select2/select2.css" />
        <link rel="stylesheet" href="../View/assets/vendor/jquery-datatables-bs3/../View/assets/css/datatables.css" />
                ...
                <section role="main" class="content-body">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">Data Logbook Peminjaman Lab</h2>
                        </header>
                        <div class="panel-body">
                            ...
                            <%
                                    ...
                                    if (conn != null){
                                        if(id!=null){
                                                    PreparedStatement pst = conn.prepareStatement ("UPDATE peminjamanlab set id=?,"
                                                        + "nama=?,nim=?,tgl_pengajuan=?,ruang=?,tgl_peminjaman=?,tgl_pengembalian=?,status=? where id='" + id + "'");
                                                    pst.setString(1, id);
                                                    pst.setString(2, nama);
                                                    pst.setString(3, nim);
                                                    pst.setString(4, tgl_pengajuan);
                                                    pst.setString(5, ruang);
                                                    pst.setString(6, tgl_peminjaman);
                                                    pst.setString(7, tgl_pengembalian);
                                                    pst.setString(8, status);
                                                    pst.executeUpdate();

                                            %>
                                            <script type="text/javascript">
                                                window.location.href="LogbookPeminjamanLab.jsp";
                                            </script>
                                            <%
                                        }
